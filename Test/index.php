		...
		<div class="td-sheets-container td-hide td-sheet-active-1">
					...
					<div class="row homepage">
						<div class="col-md-6 text-center homepageleft">
							...
							<div data-animation="fadeInUp" data-animation-delay="500" data-tdchangetext="2.5" >
								<span>Welcome to Dev Academy Iset Bizete</span>
								<span>Choose the test you want to pass</span>
								<span>Good luck </span>
							</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4 text-center td-aboutus" data-animation="zoomIn" data-animation-delay="200" data-animation-instant=true >
							<div class="td-aboutus-header">
								...
								<p style="margin-left:20%">
									<a href="HTML5/indexcour.php"><button type="submit" class="btn btn-primary btn-lg btn-block" data-animation="fadeInLeft" data-animation-delay="700">Start The Course</button></a><br><span class="ti-line-double"></span><br><br>
									<a href="HTML5/index.php"><button type="submit" class="btn btn-primary btn-lg btn-block" data-animation="fadeInLeft" data-animation-delay="700">Start Test</button></a>
							</p>
						</div>
						<div class="col-md-4 text-center td-aboutus" data-animation="zoomIn" data-animation-delay="400">
							...
							<p style="margin-left:20%">
									<a href=""><button type="submit" class="btn btn-primary btn-lg btn-block" data-animation="fadeInLeft" data-animation-delay="700">Start The Course</button></a><br><span class="ti-line-double"></span><br><br>
									<a href="HTML5/index.php"><button type="submit" class="btn btn-primary btn-lg btn-block" data-animation="fadeInLeft" data-animation-delay="700">Start Test</button></a>
							</p>
						</div>
			...
			<div class="td-sheet">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6">
							<form action="http://www.brunogarcia.net/templates/3dify/email.php" method="post">
						...
						<div class="col-md-6 contactdata">
							...
							<address>
							  ...
							  <a href="mailto:#">DevAcademy@gmail.com</a>
							</address>
						</div>
					</div>
				</div>
