       ...
       <?php include 'menu_prin.php'?>
            ...
            <div class="content-page">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="text-dark  header-title m-t-0" style="display:inline;">Tout les demande des etudiants</h4>                               
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="search" placeholder="Rechercher dans la liste des etudiants" required>
                </div><br><br>
            </div>
            <div class="col-lg-12">
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th>num</th>
                            <th>numéro de carte etudiant</th>
                            <th>CIN</th>
                            <th>Nom et prénom</th>                           
                            <th>Email</th>
                            <th>Téléphone</th>
                    ...
                    <tbody id="listetudiant">                                          
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="text-dark  header-title m-t-0">Les dernier demande de l'ensignants</h4>
...
try {
   ...
   $i=1;
   $cor = $bdd->query('SELECT *FROM enseignant');
   while($data=$cor->fetch()) {
    $a =$data["nom"];
    $b =$data["cin"];
    $c =$data["email"];
    $f =$data["tel"];
   ...
   echo "<td>$b</td>";
   echo "<td>$c</td>";
   echo "<td><form action=\"acepte_en.php\" method=\"post\">
   <input type=\"radio\" name=\"Acp\" value=\"$c\"> Acepter<br>
   <input type=\"radio\" name=\"Acp\" value=\"$b\">Refusé</td>";
