...
<head>
 ...
 <?php include 'menu_prin.php'?>
            ...
            <div class="content-page">
                        ...
                        <div class="row">
                                 ...
                                 <?php
                                  try {
                                   ...
                                   $i=1;
                                   $corr = $bdd->query('SELECT *FROM enseignant');
                                   ...
                                   echo" <div class=\"col-lg-4 col-md-6\">
                                    <div class=\"text-center card-box\">
                                        <div class=\"member-card\">
                                            ...
                                            <button type=\"button\" class=\"btn btn-success btn-sm w-sm waves-effect m-t-10 waves-light\"data-toggle=\"modal\" data-target=\"#msg\">Send message</button>
                                               <a href=\"super.php?id=" . $data["id"]. "\"><button type=\"\" class=\"btn btn-danger btn-sm w-sm waves-effect m-t-10 waves-light\">Supprimer</button></a>
                                            
                                            <div class=\"text-left m-t-40\">
                                                <p class=\"text-muted font-13\"><strong>Full Name :</strong> <span class=\"m-l-15\">$a</span></p>

                                                <p class=\"text-muted font-13\"><strong>Full CIN :</strong> <span class=\"m-l-15\">$d</span></p>
                ...
                <!-- end content -->
                <div class="modal fade" id="msg" tabindex="-1" role="dialog" aria-labelledby="contactFormModal">
