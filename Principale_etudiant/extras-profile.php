...
<!-- Mirrored from coderthemes.com/DevAcademy/blue-dark/extras-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Oct 2018 08:50:32 GMT -->
<head>
        <meta charset="utf-8">
                            ...
                            <div class="col-xl-3 col-lg-4">
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        ...
                                        <div class="">
                                            <h5 class="m-b-5"><?php echo $_SESSION["nom"]; ?></h5>
                                        ...
                                        <div class="text-left m-t-40">
                                            <p class="text-muted font-13"><strong>Full Name :</strong> <span class="m-l-15"><?php echo $_SESSION["nom"]; ?></span></p>

                                            <p class="text-muted font-13"><strong>Mobile :</strong><span class="m-l-15">(+216) <?php echo $_SESSION["tel"]; ?></span></p>

                                            <p class="text-muted font-13"><strong>Email :</strong> <span class="m-l-15"><?php echo $_SESSION["email"]; ?></span></p>

                                            <p class="text-muted font-13"><strong>Num Carte Etudiant :</strong> <span class="m-l-15"><?php echo $_SESSION["num_cart"]; ?></span></p>
                                        </div>
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form role="form" action="modif.php" method="post">
                                                    <div class="form-group">
                                                        <input type="text" name="id" value="<?= $_SESSION["id"] ?>"hidden>
                                                        <label for="FullName">Full Name</label>
                                                        <input type="text" value="<?php echo $_SESSION["nom"] ?>" id="FullName" class="form-control" name="newname">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Email">Email</label>
                                                        <input type="email" value="<?php echo $_SESSION["email"] ?>" id="Email" class="form-control" name="newemail">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Username">Login</label>
                                                        <input type="text" value="<?php echo $_SESSION["login"] ?>" id="Username" class="form-control"name="newlogin">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Password">Password</label>
                                                        <input type="password" placeholder="passoword" id="Password" class="form-control"name="passw">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="RePassword">Re-Password</label>
                                                        <input type="password" placeholder="passoword" id="RePassword" class="form-control"name="newpass">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="AboutMe">About Me</label>
                                                        <input type="textarea" placeholder="Hi I'm <?php echo $_SESSION["nom"] ?>" id="RePassword" class="form-control">
                                                    </div>
                            ...
                            <div class="timeline-2">
                                <div class="time-item">
                                    <div class="item-info">
                                        ...
                                        <p><strong><a href="#" class="text-info"><?= $_SESSION["nom"]?></a></strong> Uploaded a photo <strong>"DSC000586.jpg"</strong></p>
                                    </div>
                                </div>
...
<!-- Mirrored from coderthemes.com/DevAcademy/blue-dark/extras-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Oct 2018 08:50:34 GMT -->
</html>