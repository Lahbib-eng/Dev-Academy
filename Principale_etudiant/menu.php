            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                      <img width="95%" src="image/logo.png" alt=""></a>
                    </div>
                </div>
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown " aria-labelledby="Preview">
                                ...
                                <!-- item-->
                                <form action="deconect.php">
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <i class="mdi mdi-logout"></i> <input type="submit" value="Logout">
                                </a>
                                </form>
                            </div>
                        </li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="index.php" class="waves-effect waves-primary">
                                    <i class="ti-home"></i><span> <?php echo $_SESSION["nom"] ?></span>
                                </a>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="apps-filemanager.php">Votre Cour</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="extras-profile.php" class="waves-effect waves-primary"><i class="ti-user"></i><span>Profile</span></a></li>
                                    <li><a href="extras-timeline.php" class="waves-effect waves-primary"><i class="ti-light-bulb"></i><span>Timeline</span></a></li>
                                    <li><a href="extras-coming-soon.php" class="waves-effect waves-primary"><i class="ti-announcement"></i><span>Coming-soon</span></a></li>
                                    <li><a href="../Test/index.php" class="waves-effect waves-primary"><i class="ti-bar-chart"></i><span>DevAcademy</span></a></li>
